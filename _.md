...
def get_weather(t: datetime, lat: float, lon: float) -> Weather: pass
# should be used with the rocket datetime as to make sure the same time is picked
get_weather(r.launch_time, ...)
