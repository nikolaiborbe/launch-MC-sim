...
def filter_flight_data(flight: rocketpy.Flight) -> models.FlightData:
    """Turns a rocketpy.Flight object into landing coordinates."""
...
def construct_env(
    ...
    env.set_date(time, timezone="Europe/Oslo")
